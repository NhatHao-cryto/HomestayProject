...
const menu = [
  ...
  { to: '/system-admin/users', label: 'Quản lý người dùng' },
  { to: '/system-admin/hosts', label: 'Quản lý chủ nhà' },
  { to: '/system-admin/bookings', label: 'Quản lý booking' },
];
      ...
      <div className="flex min-h-screen">
        <aside className="w-72 border-r border-slate-200 bg-[#032452] p-6 text-white">
          <div className="mb-8">
            ...
            <p className="mt-1 text-sm text-slate-300">Quản lý toàn bộ hệ thống</p>
          </div>
        ...
        <main className="flex-1 p-6">
          <div className="mb-6 flex items-center justify-between">
            <div>
              ...
              <h1 className="text-2xl font-semibold text-slate-900">System Admin Panel</h1>
            </div>

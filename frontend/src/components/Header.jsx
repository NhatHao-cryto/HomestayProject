  ...
  return (
    <header class="fixed top-0 w-full z-50 bg-surface/80 backdrop-blur-xl border-b border-outline-variant/20 shadow-sm h-20">
      <div class="flex justify-between items-center h-full px-margin-desktop max-w-container-max mx-auto">
        {/* Logo */}
        <Link to="/" class="flex items-center gap-4 active:scale-95 transition-all duration-300">
          <img 
            alt="Luxestay Logo" 
            class="h-10 w-auto" 
          ...
          />
          <span class="font-headline-md text-headline-md text-primary tracking-tight">Luxestay</span>
        </Link>
